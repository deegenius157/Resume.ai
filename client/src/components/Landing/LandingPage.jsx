...
export const LandingPage = ({ setCurrentView }) => {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <footer ref={contactRef} className="bg-slate-900 text-slate-400 py-16 px-8 border-t border-slate-800 text-left">
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-12 text-xs">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs font-semibold text-slate-300">
              ...
              <li>
                <a href="#home" onClick={() => scrollToSection(homeRef)} className="hover:text-[#10B981] transition-colors">AI Resume Builder</a>
              </li>
            </ul>
          </div>
