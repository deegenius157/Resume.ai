...
export const LandingPage = ({ setCurrentView }) => {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      {/* HEADER NAVBAR */}
      <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md px-8 py-4 flex items-center justify-between border-b border-slate-100 max-w-7xl mx-auto">
        {/* Logo */}
        <button
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="bg-[#10B981] hover:bg-[#0E9F6E] text-white text-xs font-bold px-5 py-2.5 rounded-full shadow-sm transition"
          >
            Get started
          </button>
          ...
          <button
            ...
            className="border border-slate-200 text-slate-700 text-xs font-bold px-5 py-2.5 rounded-full hover:bg-slate-50 transition"
          >
            Login
          </button>
        </div>
      ...
      <section ref={homeRef} className="pt-16 pb-20 px-6 max-w-4xl mx-auto text-center relative">
        ...
        <p className="text-slate-500 text-base max-w-xl mb-12 leading-relaxed relative z-10 font-medium">
        ...
        <div className="flex items-center justify-center gap-4 relative z-10">
          <button onClick={() => setCurrentView('signup')} className="bg-[#10B981] hover:bg-[#0E9F6E] text-white text-xs font-black uppercase tracking-widest px-8 py-4 rounded-full shadow-2xl shadow-emerald-200 transition-all transform hover:-translate-y-1 active:scale-95">
            Get started &rarr;
          </button>
        </div>
      ...
      <section ref={featuresRef} className="py-24 bg-slate-50/40 border-t border-slate-100 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-slate-400 text-sm mb-16 max-w-xl mx-auto font-medium">Discover tools designed to bypass ATS machine filters and grab recruiter attention.</p>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group p-8 bg-white rounded-3xl border border-slate-100 text-left shadow-sm hover:shadow-xl hover:shadow-emerald-900/5 transition-all hover:-translate-y-2">
              ...
              <p className="text-slate-500 text-xs leading-relaxed font-medium">Instantly elevate casual drafts into impactful corporate summaries.</p>
            </div>
            <div className="group p-8 bg-white rounded-3xl border border-slate-100 text-left shadow-sm hover:shadow-xl hover:shadow-emerald-900/5 transition-all hover:-translate-y-2">
              <div className="w-12 h-12 bg-[#E8F9EE] rounded-2xl flex items-center justify-center text-xl mb-6 group-hover:scale-110 transition-transform">📂</div>
              <h3 className="font-black text-sm mb-3 text-slate-900 uppercase tracking-tight">Smart Parsing</h3>
              <p className="text-slate-500 text-xs leading-relaxed font-medium">Upload old PDF resumes and let AI instantly map your fields perfectly.</p>
            </div>
            <div className="group p-8 bg-white rounded-3xl border border-slate-100 text-left shadow-sm hover:shadow-xl hover:shadow-emerald-900/5 transition-all hover:-translate-y-2">
              <div className="w-12 h-12 bg-[#E8F9EE] rounded-2xl flex items-center justify-center text-xl mb-6 group-hover:scale-110 transition-transform">🚀</div>
              <h3 className="font-black text-sm mb-3 text-slate-900 uppercase tracking-tight">ATS Optimization</h3>
              <p className="text-slate-500 text-xs leading-relaxed font-medium">Format structured keywords cleanly to bypass machine filters.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer ref={contactRef} className="bg-slate-900 text-slate-400 py-16 px-8 border-t border-slate-800">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8 mb-12 text-xs">
          ...
          <div>
            <button 
              className="text-white font-extrabold text-lg tracking-tight mb-3 cursor-pointer focus:outline-none hover:opacity-85 transition"
              onClick={() => window.location.reload()}
            >
              resume.ai
            </button>
            ...
            <a
              ...
              className="text-[#10B981] hover:underline block mt-3 font-semibold transition"
            >
        ...
        <div className="max-w-6xl mx-auto border-t border-slate-800 pt-8 text-center text-[10px] tracking-wide text-slate-500">
          &copy; 2026 resume. All rights reserved. Built beautifully with PrebuiltUI assets.
        </div>
      </footer>
    </div >
  );
